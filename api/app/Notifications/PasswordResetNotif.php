...
class PasswordResetNotif extends Notification implements ShouldQueue {
    use Queueable;
    ...
    protected function resetUrl($notifiable) {
        ...
        $notifiableEmail = $notifiable->getEmailForPasswordReset();

        $builder = new URLBuilder(config("mitd.email.domain_url"));
        $builder->paths(config("mitd.email.password_reset.path"), $token)->query("email", $notifiableEmail);
